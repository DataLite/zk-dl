...
public class DLListboxManager extends Hbox {
	...
	protected static final String CONST_FILTER_MANAGER = "Správce filtrování";
	...
	public DLListboxManager() {
		...
		image.setTooltiptext("Správce položek");
		...
		image.setTooltiptext("Správce řazení");
		image.addEventListener(CONST_EVENT, new EventListener() {
			public void onEvent(final Event event) {
		...
		image = this.createImage();
		image.setTooltiptext("Exportovat");
		image.addEventListener(CONST_EVENT, new EventListener() {
		...
		image = this.createImage();
		image.setTooltiptext("Resetovat filtry");
		image.addEventListener(CONST_EVENT, new EventListener() {
		...
		image = this.createImage();
		image.setTooltiptext("Resetovat všechna nastavení");
		image.addEventListener(CONST_EVENT, new EventListener() {
	...
	public void fireChanges() {
		...
		if (filters.isEmpty()) {
			tooltip.append("žádný aktivní filtr");
